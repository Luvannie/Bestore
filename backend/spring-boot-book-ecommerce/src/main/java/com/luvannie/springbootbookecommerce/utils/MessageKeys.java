package com.luvannie.springbootbookecommerce.utils;
...
public class MessageKeys {
    ...
    public static final String UPDATE_BOOKCATEGORY_SUCCESSFULLY =  "category.update_category.update_successfully";
